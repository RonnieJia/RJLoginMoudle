...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RJBaseKit/RJBaseKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RJCategoryKit/RJCategoryKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RJNetworking/RJNetworking.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RJUtils/RJUtils.framework"
fi
